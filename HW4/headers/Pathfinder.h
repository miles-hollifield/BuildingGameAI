...
public:
    ...
    /**
     * @brief Reconstruct path from cameFrom map.
...
protected:
    int nodesExplored; // Number of nodes explored during search
    int maxFringeSize; // Maximum size of the fringe during search
    float pathCost;    // Cost of the found path
};
