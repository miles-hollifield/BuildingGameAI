...
/** OpenAI's ChatGPT was used to suggest a template header file for Heuristics's
 * implementation. The following prompt was used: "Create a template header file
 * for a class that implements heuristic functions for A* pathfinding in C++ using SFML."
 */

/**
 * @namespace Heuristics
 * @brief Contains heuristic functions for pathfinding algorithms.
 */
namespace Heuristics
{
